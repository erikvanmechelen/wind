...
- Daily, 24-hour moves (Build and Retreat phases at half the adjudication period)
- Normal press rules (press disabled in Build and Retreat phases)
- Anonymous Game - at game start, players do not know which power others are commanding
- Random Great Power - each player is assigned a country at random

## 2020 Minnesota Diplomacy Club Game on Backstabbr

I drew **Austria**, which was fine by me. From a certain point of view, Austria is the best country. (See more in the Austria chapter.)

If Italy was open to it, I wanted to try a **Modern Borders** concept. 

**Modern Borders** is just one way to play an Austrian-Italian alliance straight out of the opening. The main point is to put an Italian army in Trieste. This establishes the 'modern border' with to my eye several interesting benefits. 

The first being the early establishing of coordinated moves between two players. This solidifies intended collaboration between two parties. Between these two, they say what they will do, then they do it. There are several ways to get the army to Trieste. It can go there in Spring 1901 and then hold in Fall 1901, so as to appear as an aborted Key Lepanto. Alternatively, A Ven H in Spring and A Ven - Tri is acceptable as well. Other variations include the army traveling from Rome to Trieste.

Now, of course, the rest of the board should be sold the opposite: the Italian stabbed me!, and so on. This deception produces the second advantage, that is, tempo gains on neighbors in France, Turkey, and Russia in 1902 or 1903 depending on how the AI wants to play it.

Given my intent to play **Modern Borders**, I led assertively in my negotiations with most players. For example, notice the subject-line of my first letter to Italy.

As you'll see, in my negotiations I sought out a kind of Austrian Anschluss. See Richard Sharp for a longer discussion of the German Anschluss, whereby Germany keeps on good terms with Austria but otherwise seeds doubt among neighbors and profits from sitting back and waiting for fights to start elsewhere. (The dream according to Sharp is something like an Italian army in Marseille, and French army in Wales, and an English army in Saint Petersburg.)

Let's stay focused. We aren't playing Germany, but Austria.
...
In the Diplomacy Games Podcast Episode #61, I discussed Modern Borders as well. (Modern Borders is attributed to Andrew Goff, at least it is from him I first heard of it, and subsequently set out to test it myself in actual gameplay.)
...
Keep in mind I am pushing for A Mos - Stp. If I can send England north, that will ensure he gets into Norway, which will set up the tension in 1902 and 1903 I want between England and Russia. 
...
I was curious if the DMZ discussion with France was a partial result of my own discussion with France. I had planted a similar seed with France regarding Russian A Mos - StP and the natural English response of F Edi - NWG and F Lon - NTH, which leaves the English Channel open to a French fleet, if desired. 

I don't know exactly why I would tip off France to this possibility, except to create a good information-sharing relationship with him, as at one point in the mid-game I may like to work with him against my early game ally, Italy. 
...
In this game I was early to press, and was able to start every conversation except the one with Germany, who also had the following thread with me. 
...
The way this sentence was framed made me suspect that Russia might be played by MN Club President, Ben Johnson, as he uses similar phrasing when confirming attendance to our face-to-face league games. This *could* be used by others, as impersonation, though I thought it unlikely. Then again, others knew this about Ben, and knew I knew, so someone else could easily use a construction like this.
...
Of course, I am interested to find out if Italy goes for Trieste in the Spring or waits till Fall. Both are fine, but they do alter the negotiations I have with other players. 
...
Strategically speaking about **Modern Borders** in general, I'm undecided about whether Italy moving in Spring or Fall is better. 
...
As Brandon Fogel of Chicago pointed out when I mentioned the game result, a 17-17 draw is quite lame, if not a complete abomination, in particular how we arrived at it. As I explained briefly during that livestream linked above, as this game was *not* part of an established scoring system, I wanted to try out the AI to its conclusion for the sake of doing it. Motivationally, I imagine many Diplomacy players nodding in agreement or frustration that I don't always share their purist tendencies. What can I say? I am probably more flawed than you, dear Reader. 

I imagine that a diversity of results in a player's history helps. These are remembered by other players, studied in tournament histories, and can be raised as evidence by the player himself. Recently, I was asked whether I'd like to go for a 17-17 draw. Just as savvy Survivor players will set up to go to the final 2 or 3 with multiple players, it certainly doesn't hurt to have any one (or more) fellow diplomats believing they may go to the end alongside you. 
